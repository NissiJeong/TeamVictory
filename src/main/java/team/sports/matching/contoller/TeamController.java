   ...
   public String team(Authentication auth,Model model, @RequestParam Map map) {
      ...
      if(map.get("TEAMNAME222") == null) {   
         ...
         model.addAttribute("teamguinnessstrikeout",list14);
			...
			/*
			 * //팀기네스-최다세이브 List<TeamBoardDTO> list15 = teamDao.teamGuinnessSave(map);
			 * model.addAttribute("teamguinnesssave",list15);
			 */
         
			/*
			 * //팀기네스-최다삼진 List<TeamBoardDTO> list16 = teamDao.teamGuinnessPitch(map);
         ...
         model.addAttribute("teamguinnessstrikeout",list14);
			...
			/*
			 * //팀기네스-최다세이브 List<TeamBoardDTO> list15 = teamDao.teamGuinnessSaveSelect(map);
			 * model.addAttribute("teamguinnesssave",list15);
			 */
			/*
			 * //팀기네스-최다삼진 List<TeamBoardDTO> list16 = teamDao.teamGuinnessPitchSelect(map);
			 * model.addAttribute("teamguinnesspitch",list16);
			 */
