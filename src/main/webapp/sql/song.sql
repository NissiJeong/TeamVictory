...
CREATE SEQUENCE SEQ_baseteam INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE SEQ_Betting INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE SEQ_betting INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE SEQ_board INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE SEQ_chatmember INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE SEQ_contact INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE SEQ_fcm_tokens INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE SEQ_gameRecord INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE SEQ_Gameschedule INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE SEQ_matching INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE SEQ_message INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE SEQ_NEW_TABLE INCREMENT BY 1 START WITH 1;
create sequence seq_teammember INCREMENT BY 1 START WITH 1;
