                     ...
                     <div class="play-table">
                        <table class="table table-bordered" id="guinness-table">
                           ...
                           <tbody class="all-tbody">
                              ...
                              <tr>
                                 <!-- 기네스 제목 -->
                                 <td><span>통산 최다 투구게임</span></td>
                                 <!-- 기록 있을시 -->
                                 <c:if test="${! empty teamguinnesspitch }" var="isGuinnessScore">
                                    <c:forEach var="item" items="${teamguinnesspitch}" varStatus="loop">
                                          <!-- 기네스 수치 -->
                                          <td>${item.pitch }개</td>
                                          <!-- 기네스 날짜 -->
                                 ...
                                 <!-- 기록 없을시 -->
                                 <c:if test="${not teamguinnesspitch }">
                                    <!-- 기네스 수치 -->
                                    <td>-</td>
                                    <!-- 기네스 날짜 -->
                                    <td>경기기록이 없습니다</td>
                              ...
                              <tr>
                                 <!-- 기네스 제목 -->
                                 <td><span>통산 최다 세이브게임</span></td>
                                 <!-- 기록 있을시 -->
                                 <c:if test="${! empty teamguinnesssave }" var="isGuinnessScore">
                                    <c:forEach var="item" items="${teamguinnesssave}" varStatus="loop">
                                          <!-- 기네스 수치 -->
                                          <td>${item.sv }개</td>
                                          <!-- 기네스 날짜 -->
                                          <td>${item.gamedate } (vs ${item.ot })</td>
                                 ...
                                 <!-- 기록 없을시 -->
                                 <c:if test="${not teamguinnesssave }">
                                    <!-- 기네스 수치 -->
                                    <td>-</td>
                                    <!-- 기네스 날짜 -->
                                    <td>경기기록이 없습니다</td>
