...
<section class="blog-details-section section-padding"
	...
	<div class="container">
		<div style="padding-top: 0 !important; padding-bottom: 50px;">
	          <div class="section-header text-center" style="margin-bottom: 5px !important;">
	            <h2 class="section-title fadeIn">Team Information</h2>
	            <p>선택한 팀의 상세정보 및 기록을 확인하세요!</p>
	          </div>
	    </div>
		...
		<div class="row">
			...
			<div class="Top3-div col-lg-2 col-md-2"	style="padding-left: 0px !important; padding-top: 35px;" >
				<div class="widget widget-most-view-post" id="top3" style="width:275px;">
				<c:forEach var="item" items="${list8}" varStatus="loop">
					<c:if test="${id == item.manager_id }">
						<div class="container" style="padding-top: 15px !important; margin-bottom:5px; box-shadow: 0 0 10px 2px rgba(55, 107, 255, 0.1);">
					...
					<div style="box-shadow: 0 0 10px 2px rgba(55, 107, 255, 0.1); padding: 10px; margin-top: 15px;">
