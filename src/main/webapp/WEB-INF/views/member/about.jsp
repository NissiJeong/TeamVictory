      ...
      <div class="row justify-content-center">
        ...
        <div class="col-lg-5 col-md-6">
          <div class="about-content">
            <h2 class="title">About Butlar</h2>
      ...
      <div class="row">
        <div class="col-md-3 col-6">
          <div class="counter-item text-center">
            <div class="counter-header"><span>54</span><span>K</span></div>
            <p>Total Player</p>
          </div>
        </div><!-- counter-item end -->
        <div class="col-md-3 col-6">
          <div class="counter-item text-center">
            <div class="counter-header"><span>16</span><span>K</span></div>
            <p>Winning</p>
          </div>
        </div><!-- counter-item end -->
        <div class="col-md-3 col-6">
          <div class="counter-item text-center">
            <div class="counter-header"><span>104</span><span>K</span></div>
            <p>Register Member</p>
          </div>
        </div><!-- counter-item end -->
        <div class="col-md-3 col-6">
          <div class="counter-item text-center">
            <div class="counter-header"><span>954</span><span>K</span></div>
            <p>Play Bet</p>
          </div>
        </div><!-- counter-item end -->
      </div>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-6">
          <div class="section-header text-center">
            <h2 class="section-title">Our Tem Members</h2>
          ...
          <div class="team-single">
            ...
            <div class="content">
              ...
              <ul class="team-social d-flex">
                ...
                <li><a href="#0"><i class="fa fa-paper-plane"></i></a></li>
              </ul>
            </div>
          </div>
        </div><!-- team-single end -->
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="team-single">
            ...
            <div class="content">
              ...
              <span class="designation">Junior Advisor</span>
              <ul class="team-social d-flex">
                <li><a href="#0"><i class="fa fa-facebook-f"></i></a></li>
                <li><a href="#0"><i class="fa fa-twitter"></i></a></li>
                <li><a href="#0"><i class="fa fa-youtube"></i></a></li>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="team-single">
            ...
            <div class="content">
              ...
              <span class="designation">Idea Creator</span>
              <ul class="team-social d-flex">
                <li><a href="#0"><i class="fa fa-facebook-f"></i></a></li>
                <li><a href="#0"><i class="fa fa-twitter"></i></a></li>
                <li><a href="#0"><i class="fa fa-youtube"></i></a></li>
  ...
  <section class="faq-section section-padding section-bg">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-6">
          <div class="section-header text-center">
            <h2 class="section-title">Question And Answer</h2>
            <p>On insensible possession oh particular attachment at excellence in. The books arose but miles happy she.</p>
          </div>
        </div>
      </div>
          ...
          <div class="accordion cmn-accordion" id="accordionExample">
            <div class="card">
              <div class="card-header" id="headingOne">
                <h2 class="mb-0">
                  <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne"><i class="fa fa-question-circle"></i>Nihil anim keffiyeh helvetica.</button>
                </h2>
              </div>
            ...
            <div class="card">
              <div class="card-header" id="headingTwo">
                <h2 class="mb-0">
                  <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"><i class="fa fa-question-circle"></i>Food truck quinoa nesciunt laborum eiusmod</button>
                </h2>
              </div>
            ...
            <div class="card">
              <div class="card-header" id="headingThree">
                <h2 class="mb-0">
                  <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree"><i class="fa fa-question-circle"></i>Leggings occaecat craft beer farm-to-table</button>
                </h2>
              </div>
            ...
            <div class="card">
              <div class="card-header" id="headingFour">
                <h2 class="mb-0">
                  <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour"><i class="fa fa-question-circle"></i>Food truck quinoa nesciunt laborum eiusmod</button>
                </h2>
              </div>
          ...
          <div class="accordion cmn-accordion" id="accordionExample2">
            <div class="card">
              <div class="card-header" id="headingFive">
                <h2 class="mb-0">
                  <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseFive" aria-expanded="true" aria-controls="collapseFive"><i class="fa fa-question-circle"></i>Ad vegan excepteur butcher vice lomo</button>
                </h2>
              </div>
            ...
            <div class="card">
              <div class="card-header" id="headingSix">
                <h2 class="mb-0">
                  <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix"><i class="fa fa-question-circle"></i>Leggings occaecat craft beer farm-to-table</button>
                </h2>
              </div>
            ...
            <div class="card">
              <div class="card-header" id="headingSeven">
                <h2 class="mb-0">
                  <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven"><i class="fa fa-question-circle"></i>Craft beer labore wes anderson cred nesciunt</button>
                </h2>
              </div>
