...
<section class="contact-section section-padding">
   <div class="container">
      ...
      <div id="container" style="margin-left: 19%; margin-top: 3%;">
         <div id="contentArea">
            <div class="contentBody">
               <h3 class="contentTit" style="margin-left: 10%; margin-bottom: 1%;">문의게시판</h3>
               ...
               <form name="frm_write" id="frm_write" method="POST"
                  ...
                  <div class="formArea">
                     <table class="form">
                        ...
                        <tr>
                           <th scope="row" style="width: 10%;"><label for="title">제목</label></th>
                        ...
                        <tr>
                           ...
                           <td style=" padding-top: 17px;"><input type="text" name="mailname" id="mailname"
                        ...
                        <tr>
                           ...
                           <td style="padding-top: 5px;"><textarea id="iq_cont" class="txtArea4" name="content"
			 ...
			 <input type="submit" value="보내기" id="btnAjaxText" class="btn btn-info" style="margin-left: 516px;"/>
